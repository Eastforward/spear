"""Generate new Hunyuan3D meshes (beagle_v2, british_shorthair_v2), drop them
...
# Review-generation tags use normalized production legacy names. Older
# direction-only tags (dog_beagle, cat_british_shorthair) are intentionally not
...
def main():
    ...
    ap.add_argument("--tags", nargs="*",
                     help="Only process these tag names (default: normalized v2 review tags).")
    args = ap.parse_args()
